...
public class WeChatApiUtil {
    ...
    private static final String TAG = "WeChatApiUtil";
    ...
    public static String getQrCode(String uuid) throws WeChatException {
        return getQrCode(uuid, System.getProperty("java.io.tmpdir"));
    }

    public static String getQrCode(String uuid, String path) throws WeChatException {
        if (StringKit.isBlank(uuid)) {
            throw new WeChatException("请先获取UUID");
        }
        String url = Constant.QRCODE_URL + uuid;
        final File output = new File(path, "wechat4j_qrcode.jpg");
    ...
    public static String getQrCodeUrl(String uuid) throws WeChatException {
        if (StringKit.isBlank(uuid)) {
            throw new WeChatException("请先获取UUID");
        }
